...
To get started, simply fork this repo. Please refer to [CONTRIBUTING.md](https://github.com/tuvtran/project-based-learning/blob/97afefeb79ffb67a865adef90b20c0e61d1d581a/CONTRIBUTING.md) for contribution guidelines.

## Table of Contents:

* [C\#](tuvtran-project-based-learning.md#c)
* [C/C++](tuvtran-project-based-learning.md#cc)
* [Clojure](tuvtran-project-based-learning.md#clojure)
* [Elixir](tuvtran-project-based-learning.md#elixir)
* [Erlang](tuvtran-project-based-learning.md#erlang)
* [F\#](tuvtran-project-based-learning.md#f)
* [Go](tuvtran-project-based-learning.md#go)
* [Haskell](tuvtran-project-based-learning.md#haskell)
* [HTML/CSS](tuvtran-project-based-learning.md#html-and-css)
* [Java](tuvtran-project-based-learning.md#java)
* [JavaScript](tuvtran-project-based-learning.md#javascript)
* [Kotlin](tuvtran-project-based-learning.md#kotlin)
* [Lua](tuvtran-project-based-learning.md#lua)
* [OCaml](tuvtran-project-based-learning.md#ocaml)
* [PHP](tuvtran-project-based-learning.md#php)
* [Python](tuvtran-project-based-learning.md#python)
* [R](tuvtran-project-based-learning.md#r)
* [Ruby](tuvtran-project-based-learning.md#ruby)
* [Rust](tuvtran-project-based-learning.md#rust)
* [Scala](tuvtran-project-based-learning.md#scala)
* [Swift](tuvtran-project-based-learning.md#swift)
* [Additional resources](tuvtran-project-based-learning.md#additional-resources)
