...
To get started, simply fork this repo. Please refer to [CONTRIBUTING.md](blob/master/tuvtran-project-based-learning-2.md) for contribution guidelines.

## Table of Contents:

* [C\#](tuvtran-project-based-learning-6.md#c)
* [C/C++](tuvtran-project-based-learning-6.md#cc)
* [Clojure](tuvtran-project-based-learning-6.md#clojure)
* [Elixir](tuvtran-project-based-learning-6.md#elixir)
* [Erlang](tuvtran-project-based-learning-6.md#erlang)
* [F\#](tuvtran-project-based-learning-6.md#f)
* [Go](tuvtran-project-based-learning-6.md#go)
* [Haskell](tuvtran-project-based-learning-6.md#haskell)
* [HTML/CSS](tuvtran-project-based-learning-6.md#html-and-css)
* [Java](tuvtran-project-based-learning-6.md#java)
* [JavaScript](tuvtran-project-based-learning-6.md#javascript)
* [Kotlin](tuvtran-project-based-learning-6.md#kotlin)
* [Lua](tuvtran-project-based-learning-6.md#lua)
* [OCaml](tuvtran-project-based-learning-6.md#ocaml)
* [PHP](tuvtran-project-based-learning-6.md#php)
* [Python](tuvtran-project-based-learning-6.md#python)
* [R](tuvtran-project-based-learning-6.md#r)
* [Ruby](tuvtran-project-based-learning-6.md#ruby)
* [Rust](tuvtran-project-based-learning-6.md#rust)
* [Scala](tuvtran-project-based-learning-6.md#scala)
* [Swift](tuvtran-project-based-learning-6.md#swift)
* [Additional resources](tuvtran-project-based-learning-6.md#additional-resources)
